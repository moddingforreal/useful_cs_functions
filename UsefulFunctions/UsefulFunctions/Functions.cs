...
namespace UsefulFunctions
{
    public class Functions
    {
        ...
        public void old_slowwrite(string text, int duration_milliseconds)
        {
            string printtext = "";
            for (int i = 0; i <= text.Length; i++)
            {
        ...
        public void cycle_rand_textcolor(int wait_time_millisecs)
        {
            Random r = new Random();
        ...
        public void cycle_rand_backgroundcolor(int wait_time_millisecs)
        {
            Random r = new Random();
            ConsoleColor[] consoleColors = (ConsoleColor[])ConsoleColor.GetValues(typeof(ConsoleColor));
            while (true)
        ...
        public double power_of(double base_num, double exponent_num)
        {
            double result = 0;
            if (exponent_num == 0)
            {
        ...
        public double NthRootOf(double number, double e)
        {
        ...
        public string replace_strings(string[] replace_strings, string[] strings_to_replace, string original)
        {
            string res = "";
        ...
        public string path_of_exe()
        {
            string path = System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetEntryAssembly().Location);
            return path;
        }
        public string PathOfExeWithPath()
        {
            string path = System.Reflection.Assembly.GetEntryAssembly().Location;
            return path;
        }
        public void create_batch_cmd_command(int mode, string save_path, string filename, string commands)
        {
            switch(mode)
            {
                case 0:
        ...
        public void register_cmd_command(string file_with_path, string filename)
        {
            System.IO.File.Move(file_with_path, @"C:\Windows\System32\" + filename);
        }
        public double area_of_circle(double radius_or_diameter, bool is_diameter)
        {
        ...
        public void change_console_encoding(string encoding, bool change_input_enc, bool change_output_enc)
        {
        ...
        public string owofy(string original)
        {
            string[] abca = { "w", "w", "W", "W" };
            string[] abcb = { "r", "l", "R", "L" };
